<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 p-6 transition-colors">
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            Remplissez tous les champs requis pour ajouter un nouveau professeur
          </p>
        </div>
        <div class="flex space-x-3">
          ...
          >
            ...
            <span v-else>Enregistrer le professeur</span>
          </button>
        </div>
      </div>
    </div>
    ...
    <!-- Formulaire -->
    <form id="teacher-form" @submit.prevent="submitUser" class="space-y-6">
      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-green-50 to-teal-50 dark:from-gray-700 dark:to-gray-800">
          ...
          <p class="mt-1 text-sm text-gray-600 dark:text-gray-400 ml-7">Téléchargez les pièces justificatives requises</p>
        </div>
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Pièce d'identité ou passeport <span class="text-red-500">*</span>
              </label>
              <FileUpload
            ...
            <div v-if="form.nationalite === 'Togo'">
              <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Justificatif du NIF <span class="text-red-500">*</span>
              </label>
              <FileUpload
                id="nif-document"
            ...
            <div class="flex items-start space-x-3">
              ...
              <div class="text-sm text-blue-800 dark:text-blue-200">
                ...
                <ul class="space-y-2">
                  ...
                  <li class="flex items-start space-x-2">
                    <span class="text-blue-500 mt-1">•</span>
                    <span><strong>Pièce d'identité :</strong> Document obligatoire pour tous les professeurs</span>
                  </li>
                  <li class="flex items-start space-x-2">
                    <span class="text-blue-500 mt-1">•</span>
...
const validateForm = () => {
  ...
  if (!form.value.identity_document) {
    $swal.fire({ icon: "error", title: "Document manquant", text: "La pièce d'identité est obligatoire.", confirmButtonColor: "#6366f1" })
    return false
  }
  ...
  if (form.value.nationalite === 'Togo') {
    ...
    if (!form.value.nif_document) {
      $swal.fire({ icon: "error", title: "Document manquant", text: "Le justificatif du NIF est obligatoire pour les professeurs togolais.", confirmButtonColor: "#6366f1" })
      return false
    }
  }
...
const submitUser = async () => {
  ...
  try {
    ...
    await userStore.addEnseignant(formData)
    ...
    $swal.fire({
      icon: "error",
      title: "Erreur",
      text: error.message || "Impossible d'ajouter le professeur.",
      confirmButtonColor: "#6366f1"
    })
  } finally {
