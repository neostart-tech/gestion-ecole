				...
				<div class="mb-10">
					...
					>
						...
						<template v-if="newUser.photoUrl">
							...
							/>
							<div
								class="absolute inset-0 bg-black bg-opacity-60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center text-white"
							>
								<svg
						...
						<template v-else>
							<div
								class="flex flex-col items-center justify-center p-10 text-center h-56"
							>
								<svg
									class="w-16 h-16 text-gray-400 mb-5"
									fill="none"
									stroke="currentColor"
									viewBox="0 0 24 24"
								>
				...
				<div class="mb-10">
					...
					<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
						...
						<div>
							...
							/>
							<p v-if="formErrors.username" class="mt-2 text-sm text-red-600">
								{{ formErrors.username }}
							</p>
						</div>
						...
						<div>
							...
							/>
							<p v-if="formErrors.active" class="mt-2 text-sm text-red-600">
								{{ formErrors.active }}
							</p>
						</div>
...
<<<<<<< HEAD
				...
				<div class="mb-10">
					...
					<div>
						...
						<EditorTinyMCE v-model="newUser.notes" :disabled="isSubmitting" />
							...
							<div class="flex items-start gap-3">
								...
								<div class="text-sm text-blue-700">
									<p class="font-medium mb-1">
										🚀 Configuration requise pour TinyMCE
									</p>
									<ol class="list-decimal pl-4 space-y-1">
										<li>
											Ajoutez votre clé API dans le composant EditorTinyMCE
										</li>
										<li>
											Configurez votre domaine dans le tableau de bord TinyMCE
										</li>
										<li>
											Profitez de l'éditeur de texte riche avec toutes les
											fonctionnalités
										</li>
									</ol>
									<div class="mt-3">
										<a
											href="https://www.tiny.cloud/docs/tinymce/6/react-cloud/#create-an-api-key"
											target="_blank"
