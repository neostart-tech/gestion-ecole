<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 sm:p-6 transition-colors duration-500">
    ...
    <!-- Fil d'Ariane & Titre -->
    <div class="mb-8">
      <nav class="flex items-center gap-2 text-xs font-bold uppercase tracking-widest text-gray-400 dark:text-gray-600 mb-2">
...
.premium-table :deep(tbody tr:hover td) { @apply bg-violet-50/30 dark:bg-violet-900/5; }
