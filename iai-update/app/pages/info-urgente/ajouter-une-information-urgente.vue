      ...
      <form @submit.prevent="savePublication" class="space-y-6">
        ...
        <div class="space-y-2">
          ...
          <div
            ...
            class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl p-4 text-center cursor-pointer hover:border-indigo-500 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all font-medium"
          >
            ...
            <div v-else class="py-2">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">Ajouter une image</p>
            </div>
        ...
        <div class="space-y-2">
          ...
          >
            ...
            <p class="text-sm text-gray-500 dark:text-gray-400">Ajouter des fichiers joints</p>
          ...
          <div v-if="form.attachments.length" class="space-y-2 mt-4">
            <div v-for="(file, index) in form.attachments" :key="index" class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
              <div class="flex items-center gap-3 truncate">
                <svg class="w-5 h-5 text-gray-400 dark:text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                </svg>
                <span class="text-sm text-gray-700 dark:text-gray-300 truncate font-semibold">{{ file.name }}</span>
              </div>
