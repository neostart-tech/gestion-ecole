<template>
	...
	>
		...
		<div class="flex items-end mb-6">
			<NuxtLink
				to="/filières/list"
				class="flex items-center gap-2 px-4 py-2 text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
			>
				<svg
					class="w-5 h-5"
					fill="none"
		...
		<div class="max-w-2xl mx-auto">
			<div
				class="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/30 p-6 md:p-8 transition-colors duration-300"
			>
...
<style scoped>
	...
	/* Styles pour les inputs radio en mode sombre */
	...
	/* Focus states améliorés pour le mode sombre */
	.dark input:focus,
	.dark textarea:focus {
