        ...
        <div v-else class="mt-8">
          <form class="space-y-6" @submit.prevent="handleSubmit">
            ...
            <div class="space-y-1.5">
              ...
              <input id="password" v-model="password" name="password" type="password" required minlength="8"
            ...
            <div class="space-y-1.5">
              ...
              <input id="password_confirmation" v-model="passwordConfirmation" name="password_confirmation" type="password" required minlength="8"
