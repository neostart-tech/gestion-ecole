<template>
  <div class="min-h-screen bg-transparent pt-4 pb-10">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
            <div class="p-2 bg-gradient-to-br from-[#01b4d5] to-[#009ab5] rounded-[10px] shadow-lg">
        ...
        <div class="flex items-center gap-2">
          <button
            ...
            class="inline-flex items-center px-3 py-2 border border-gray-300 dark:border-[#242438] text-sm font-medium rounded-[10px] text-gray-700 dark:text-gray-300 bg-white dark:bg-[#1a1a2a] hover:bg-gray-50 dark:hover:bg-[#242438] transition-colors"
            :disabled="isLoading"
          >
          ...
          <button
            ...
            class="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-[10px] text-white bg-[#01b4d5] hover:bg-[#009ab5] transition-colors shadow-sm hover:shadow"
          >
    ...
    <div class="max-w-7xl mx-auto">
      <div class="bg-white dark:bg-[#11111e] rounded-[10px] shadow-md overflow-hidden">
        <!-- En-tête des onglets -->
          ...
          <div class="px-4 sm:px-6">
            <nav class="flex space-x-6 overflow-x-auto scrollbar-hide" aria-label="Tabs">
              ...
              >
                ...
                Toutes
                <span class="ml-1 py-0.5 px-2 bg-gray-100 dark:bg-gray-800 rounded-full text-xs font-medium text-gray-700 dark:text-gray-300">
          ...
          <div class="flex items-center justify-between flex-wrap gap-2">
            <div class="flex items-center gap-2">
              <label class="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  v-model="selectAll"
                  class="w-4 h-4 text-[#01b4d5] border-gray-300 dark:border-gray-600 rounded focus:ring-[#01b4d5]"
                >
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="inline-flex items-center px-2.5 py-1.5 border border-gray-300 dark:border-[#242438] text-xs font-medium rounded-[10px] text-gray-700 dark:text-gray-300 bg-white dark:bg-[#1a1a2a] hover:bg-gray-50 dark:hover:bg-[#242438] transition-colors"
                :disabled="isLoading"
              >
              ...
              <button
                v-if="selectedNotifications.length > 0"
                @click="bulkDelete"
                class="inline-flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded-[10px] text-white bg-red-600 hover:bg-red-700 transition-colors"
                :disabled="isLoading"
              >
                <svg class="w-3.5 h-3.5 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div v-else class="divide-y divide-gray-100 dark:divide-[#1a1a2a]">
          ...
          <div v-if="currentNotifications.length === 0" class="p-12 text-center">
            <div class="max-w-sm mx-auto">
              <div class="w-24 h-24 mx-auto bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-full flex items-center justify-center mb-4">
              ...
              <button
                v-if="currentTab !== 'all'"
                @click="currentTab = 'all'"
                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-[10px] text-white bg-[#01b4d5] hover:bg-[#009ab5] transition-colors"
              >
          ...
          <div v-else>
            <div
              ...
              :key="notification.id"
              class="p-4 sm:p-6 hover:bg-gray-50 dark:hover:bg-[#1a1a2a]/50 transition-colors relative group"
              :class="{
                'bg-gradient-to-r from-cyan-50/50 dark:from-cyan-950/20 to-transparent': !notification.lu && currentTab !== 'read'
              }"
            >
              <div class="flex items-start gap-4">
                ...
                <div class="flex-shrink-0">
                  <div
                    :class="[
                      'w-10 h-10 rounded-[10px] flex items-center justify-center shadow-sm',
                ...
                <div class="flex-1 min-w-0">
                  <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
                    ...
                    <div class="flex flex-col items-end gap-2">
                      ...
                      <span
                        :class="[
                          'inline-flex items-center px-2 py-1 rounded-[10px] text-xs font-medium',
                  ...
                  <div class="mt-3 flex flex-wrap items-center gap-3 text-xs">
                    ...
                    <span v-if="notification.lu" class="text-green-600 flex items-center gap-1">
                      <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                      </svg>
                      Lu
                ...
                <div class="flex-shrink-0 flex items-start gap-1">
                  <button
                    ...
                    class="p-2 rounded-[10px] text-gray-400 hover:text-[#01b4d5] hover:bg-cyan-50 dark:hover:bg-cyan-950/40 transition-all"
                  ...
                  <button
                    ...
                    class="p-2 rounded-[10px] text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all"
                    title="Supprimer"
                  >
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
          ...
          <div class="flex flex-col sm:flex-row items-center sm:justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="p-2 rounded-[10px] border border-gray-300 dark:border-[#242438] text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1a1a2a] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const bulkMarkAsRead = async () => {
  if (!confirm(`Voulez-vous marquer ${selectedNotifications.value.length} notification(s) comme lue(s) ?`)) return;
  try {
...
const bulkDelete = async () => {
  if (!confirm(`Voulez-vous supprimer ${selectedNotifications.value.length} notification(s) ?`)) return;
  try {
...
const confirmMarkAllAsRead = async () => {
  ...
  if (!confirm(`Voulez-vous marquer toutes les ${unreadIds.length} notifications non lues comme lues ?`)) return;
  try {
