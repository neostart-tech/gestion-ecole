              ...
              <div>
                ...
                <div class="flex flex-wrap items-center justify-center md:justify-start gap-x-4 md:gap-x-6 gap-y-2 mt-3">
                  ...
                  <div class="flex items-center gap-2 text-xs md:text-sm text-gray-500 dark:text-gray-400 font-medium">
                    ...
                    {{ etudiantStore.etudiant.tel || etudiantStore.etudiant.telephone || '—' }}
                  </div>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div v-for="role in ['tuteur', 'responsable']" :key="role" class="p-5 md:p-6 bg-gray-50 dark:bg-gray-900/30 rounded-3xl border border-gray-100 dark:border-gray-800">
                  ...
                  <div class="space-y-4" v-if="etudiantStore.etudiant[role] && (etudiantStore.etudiant[role].nom || etudiantStore.etudiant[role].prenom)">
                    ...
                    <div v-if="etudiantStore.etudiant[role].tel" class="space-y-1">
                    ...
                    <div v-if="etudiantStore.etudiant[role].email" class="space-y-1">
                      <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Email</p>
                      <p class="text-sm font-bold text-indigo-600 dark:text-indigo-400">{{ etudiantStore.etudiant[role].email }}</p>
                    </div>
                    <div v-if="etudiantStore.etudiant[role].profession" class="space-y-1">
                      <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Profession</p>
                      <p class="text-sm font-bold text-gray-800 dark:text-gray-200">{{ etudiantStore.etudiant[role].profession }}</p>
                    </div>
                    <div v-if="etudiantStore.etudiant[role].adresse" class="space-y-1">
                      <p class="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none">Adresse</p>
                      <p class="text-xs font-medium text-gray-600 dark:text-gray-400">{{ etudiantStore.etudiant[role].adresse }}</p>
                    </div>
                  </div>
...
const personalInfo = computed(() => [
    ...
    { label: 'Téléphone', value: etudiantStore.etudiant?.tel || etudiantStore.etudiant?.telephone },
    { label: 'Adresse de résidence', value: etudiantStore.etudiant?.adresse }
]);
