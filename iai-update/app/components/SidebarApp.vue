              ...
              >
				...
				>
					...
					<ul class="space-y-1">
						...
						<li
							v-if="
								hasAnyRole(['directeur-general', 'directeur-general-adjoint'])
							"
						>
							<NuxtLink
								to="/parametre/liste"
	...
	const fetchRoles = () => {
		try {
			...
			for (const role of roles) {
				...
				if (slug === "responsable-administratif-et-financier")
					isRAF.value = true;
				...
				if (slug === "responsable-marketing")
					isResponsableMarketing.value = true;
