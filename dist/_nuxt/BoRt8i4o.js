import{aB as t,ca as m,bW as l,c,o as s,av as i,a as p,aU as d}from"./BNgVrraw.js";import{s as g}from"./BGwMTKfw.js";var h=`
    .p-imagecompare {
        position: relative;
        overflow: hidden;
        width: 100%;
...
`,u={root:"p-imagecompare",slider:"p-imagecompare-slider"},b=t.extend({name:"imagecompare",style:h,classes:u}),v={name:"BaseImageCompare",extends:g,props:{tabindex:{type:Number,default:0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:b,provide:function(){return{$pcImageCompare:this,$parentInstance:this}}},f={name:"ImageCompare",extends:v,methods:{onSlide:function(a){var n=a.target.value,o=a.target.previousElementSibling;m(o,l("imagecompare.scope.x").name,"".concat(n,"%"))}}},w=["aria-labelledby","aria-label"];function y(e,a,n,o,z,r){return s(),c("div",d({class:e.cx("root"),"aria-labelledby":e.ariaLabelledby,"aria-label":e.ariaLabel},e.ptmi("root")),[i(e.$slots,"left"),i(e.$slots,"right"),p("input",d({type:"range",min:"0",max:"100",value:"50",onInput:a[0]||(a[0]=function(){return r.onSlide&&r.onSlide.apply(r,arguments)}),class:e.cx("slider")},e.ptm("slider")),null,16)],16,w)}f.render=y;export{f as default};
