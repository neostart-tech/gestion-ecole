<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 p-4 sm:p-6 lg:p-8 transition-colors duration-300">
    ...
    <div v-if="store.isLoading" class="max-w-7xl mx-auto space-y-6 animate-pulse">
      <!-- Profile Header Skeleton -->
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-6 flex items-center gap-6">
        <div class="w-20 h-20 bg-gray-100 dark:bg-gray-700 rounded-xl"></div>
        <div class="flex-1 space-y-3">
          <div class="h-8 bg-gray-200 dark:bg-gray-700 rounded w-1/3"></div>
          <div class="flex gap-4">
            <div class="h-4 bg-gray-100 dark:bg-gray-700 rounded w-24"></div>
            <div class="h-4 bg-gray-100 dark:bg-gray-700 rounded w-32"></div>
          </div>
        </div>
        <div class="h-10 bg-gray-100 dark:bg-gray-700 rounded-lg w-32 hidden md:block"></div>
      </div>

      <!-- Financial Cards Skeleton -->
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div v-for="i in 4" :key="i" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 p-5 space-y-3">
          <div class="h-4 bg-gray-100 dark:bg-gray-700 rounded w-1/2"></div>
          <div class="h-8 bg-gray-200 dark:bg-gray-700 rounded w-3/4"></div>
          <div class="h-3 bg-gray-50 dark:bg-gray-700 rounded w-1/3"></div>
        </div>
      </div>

      <!-- Academic History Skeleton -->
      <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-4 space-y-4">
          <div v-for="i in 3" :key="i" class="flex gap-4 items-center">
            <div class="h-12 w-12 bg-gray-100 dark:bg-gray-700 rounded-lg"></div>
