  ...
  <path d="M9 4.804A7.968 7.968 0 005.5 4c-1.255 0-2.443.29-3.5.804v10A7.969 7.969 0 015.5 14c1.669 0 3.218.51 4.5 1.385A7.962 7.962 0 0114.5 14c1.255 0 2.443.29 3.5.804v-10A7.968 7.968 0 0014.5 4c-1.255 0-2.443.29-3.5.804V12a1 1 0 11-2 0V4.804z" />
        ...
        >
          ...
          <ul class="space-y-1">
            ...
            >
              <NuxtLink
                to="/parametre/champs-obligatoires"
                class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group"
                :class="[
                  $route.path === '/parametre/champs-obligatoires'
                    ? 'bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 text-amber-700 dark:text-amber-400'
                    : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300',
                ]"
                @click="toggleMobileMenu"
            ...
            >
              <NuxtLink
                to="/parametre/types-diplome"
                class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group"
                :class="[
                  $route.path === '/parametre/types-diplome'
                    ? 'bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 text-amber-700 dark:text-amber-400'
                    : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300',
                ]"
                @click="toggleMobileMenu"
              >
                ...
                >
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2a1 1 0 10-2 0v2a1 1 0 001 1z" />
                  </svg>
                </div>
                <span
                  v-if="themeStore.isSidebarOpen"
                  class="ml-3 font-medium flex-1"
                  >Types de diplôme</span
                >
                <div
                  v-if="
                    themeStore.isSidebarOpen &&
            ...
            >
              <NuxtLink
                to="/parametre/moyens-connaissance"
                class="flex items-center px-3 py-2.5 rounded-xl transition-all duration-200 group"
                :class="[
                  $route.path === '/parametre/moyens-connaissance'
                    ? 'bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 text-amber-700 dark:text-amber-400'
                    : 'hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-700 dark:text-gray-300',
                ]"
                @click="toggleMobileMenu"
