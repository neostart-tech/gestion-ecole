    ...
    <div class="flex items-center justify-between px-3 sm:px-4 py-2 sm:py-3">
      ...
      <div class="flex items-center space-x-1 sm:space-x-2 md:space-x-4">
        ...
        >
          ...
          <!-- Tooltip desktop -->
          <span
            class="absolute hidden lg:group-hover:block -bottom-8 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white text-xs py-1 px-2 rounded whitespace-nowrap"
          >
            {{
              currentMode === "auto"
                ? "Auto"
        ...
        <div class="relative">
          <button
            ...
            class="p-1.5 sm:p-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative group"
            :class="{
              'ring-2 ring-indigo-400 dark:ring-indigo-500 ring-offset-2 dark:ring-offset-gray-800':
          ...
          >
            <div
              ...
              class="absolute right-0 mt-2 w-[calc(100vw-2rem)] sm:w-96 max-w-[calc(100vw-2rem)] sm:max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 flex flex-col transition-all duration-200 sm:right-0 -right-4 sm:right-0"
              :class="[
            ...
            >
              ...
              <div
                class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 to-white dark:from-gray-800 dark:to-gray-800/50 rounded-t-xl"
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center space-x-2">
                    <div
                      class="p-1.5 bg-indigo-100 dark:bg-indigo-900/30 rounded-lg"
                    >
                      <svg
                ...
                <div class="mt-2 flex items-center justify-between">
                  ...
                  >
                    <svg
                      class="w-3 h-3"
                      :class="{ 'animate-spin': notificationStore.isLoading }"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
              ...
              <div v-if="notificationStore.isLoading" class="p-8 text-center">
                <div class="flex flex-col items-center justify-center">
                  <div class="relative">
                    <div
                      class="w-10 h-10 border-3 border-indigo-200 border-t-indigo-600 rounded-full animate-spin"
                    ></div>
                  </div>
              ...
              <div v-else class="flex-1 overflow-y-auto">
                ...
                <div v-if="notifications.length === 0" class="p-8 text-center">
                  <div class="relative">
                    <div
                      class="w-20 h-20 mx-auto bg-gradient-to-br from-gray-100 to-gray-50 dark:from-gray-700 dark:to-gray-800 rounded-full flex items-center justify-center mb-4"
                    >
                      <svg
                    ...
                    <h4
                      class="text-gray-900 dark:text-white font-medium text-base sm:text-lg mb-1"
                    >
                      Aucune notification
                    </h4>
                    <p
                      class="text-xs sm:text-sm text-gray-500 dark:text-gray-400 max-w-[220px] mx-auto"
                    >
                      Vous n'avez aucune notification pour le moment. Les
                      nouvelles notifications apparaîtront ici.
                    </p>

                    <!-- Illustration de notification -->
                    <div class="mt-6 flex justify-center gap-2">
                      <div
                        class="w-1.5 h-1.5 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"
                      ></div>
                      <div
                        class="w-1.5 h-1.5 bg-gray-300 dark:bg-gray-600 rounded-full animate-pulse"
              ...
              <!-- Footer avec actions -->
              <div
                class="p-2 sm:p-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-b-xl"
              >
                <div class="flex items-center justify-between">
                  <NuxtLink
                    to="/notifications"
        ...
        <div class="relative">
          ...
          >
            ...
            <div class="hidden md:block text-left">
              ...
              <p
                class="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 max-w-[120px] truncate"
              >
                {{ userInfo.email }}
              </p>
            </div>
          ...
          >
            <div
              ...
              class="absolute right-0 mt-2 w-56 sm:w-64 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 py-2 transition-all duration-200 right-0"
            >
              <div
...
const getNotificationStyle = (type: string) => {
  ...
  if (type.includes("CommunicationPublishedNotification")) {
    return {
      icon: '<svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5.882V19.24a1.76 1.76 0 01-3.417.592l-2.147-6.15M18 13a3 3 0 100-6M5.436 13.683A4.001 4.001 0 017 6h1.832c4.1 0 7.625-1.234 9.168-3v14c-1.543-1.766-5.067-3-9.168-3H7a3.988 3.988 0 01-1.564-.317z" /></svg>',
...
// D'anciennes actualités (avant correction du backend) ont été enregistrées avec
// des entités HTML littérales (&eacute;, &agrave;...) laissées par l'éditeur
// TinyMCE : le contenu déjà stocké dans la table notifications (un instantané au
// moment de l'envoi) ne se corrige pas tout seul même après le fix backend. On
// décode donc ici en filet de sécurité pour l'affichage.
